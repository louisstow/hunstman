...
class Spider extends events_1.EventEmitter {
    ...
    crawlNextItems() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(buffer.map((item, i) => this.runQueueItem(item, i)));
        });
    }
    runRequestMiddleware(item, bufferIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            let r = item.request;
            for (let i = 0; i < this.middleware.length; ++i) {
                r = yield this.middleware[i].processRequest(r, this, bufferIndex);
    ...
    runQueueItem(item, bufferIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            const req = yield this.runRequestMiddleware(item, bufferIndex);
            if (req === null) {
