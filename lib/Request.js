...
class Request {
    ...
    setResponse(resp) {
        var _a, _b;
        const r = new Response_1.Response(this, ((_b = (_a = resp.request) === null || _a === void 0 ? void 0 : _a.res) === null || _b === void 0 ? void 0 : _b.responseUrl) || this.url, resp.status, resp.statusText, resp.headers, resp.data, resp.data);
        this.response = r;
        return r;
    }
    createAxiosProps() {
