...
class Request {
    ...
    setResponse(resp) {
        var _a;
        const r = new Response_1.Response(this, (_a = resp === null || resp === void 0 ? void 0 : resp.request) === null || _a === void 0 ? void 0 : _a.responseURL, resp.status, resp.statusText, resp.headers, resp.data, resp.data);
        this.response = r;
        return r;
    }
    createAxiosProps() {
